...
class OfferService:
    ...
    async def deactivate_offer(
        ...
        try:
        ...
        except (OfferNotFoundException, NotOfferOwnerException, 
                InvalidStatusTransitionException, OfferAlreadyInactiveException):
            ...
            raise OfferModificationFailedException(operation="deactivate", details=str(e))
    ...
    async def mark_offer_as_sold(
        ...
        try:
            ...
            if offer.status in [OfferStatus.ARCHIVED, OfferStatus.DELETED]:
                raise InvalidStatusTransitionException(
                    current_status=offer.status,
                    target_status=OfferStatus.SOLD
                )
            ...
            return self._map_to_offer_detail_dto(offer, seller, category)
                ...
                InvalidStatusTransitionException, OfferAlreadySoldException):
            # Re-raise custom exceptions
            raise
        except HTTPException:
            # Re-raise HTTP exceptions
            ...
            raise OfferModificationFailedException(operation="mark_sold", details=str(e)) 
    ...
    async def moderate_offer(self, offer_id: UUID) -> OfferDetailDTO:
        ...
        try:
            ...
            raise OfferModificationFailedException(operation="moderation", details=str(e))
    ...
    async def unmoderate_offer(self, offer_id: UUID) -> OfferDetailDTO:
        ...
        try:
            ...
            raise OfferModificationFailedException(operation="unmoderation", details=str(e))
        # Fetch related entities for full DTO
        seller = await self.db_session.get(UserModel, offer.seller_id)
        category = await self.db_session.get(CategoryModel, offer.category_id)
        return self._map_to_offer_detail_dto(offer, seller, category) 