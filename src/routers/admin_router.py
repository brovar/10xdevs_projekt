...
from schemas import (AdminLogListQueryParams, AdminOfferListQueryParams,
                     ...
                     OrderDetailDTO, OrderListResponse, UserDTO,
                     UserListQueryParams, UserListResponse)
...
@router.post(
    ...
    responses={
        ...
        500: {
            "description": "Server error while blocking user",
            "content": {
                "application/json": {
                    "example": {
...
@router.post(
    ...
    responses={
        ...
        500: {
            "description": "Server error while unblocking user",
            "content": {
                "application/json": {
                    "example": {
...
@router.post(
    ...
    responses={
        ...
        409: {
            "description": "Offer is already moderated",
            "content": {
                "application/json": {
                    "example": {
        ...
        500: {
            "description": "Server error while moderating offer",
            "content": {
                "application/json": {
                    "example": {
...
@router.post(
    ...
    responses={
        ...
        409: {
            "description": "Offer is not moderated",
            "content": {
                "application/json": {
                    "example": {
        ...
        500: {
            "description": "Server error while unmoderating offer",
            "content": {
                "application/json": {
                    "example": {
...
async def cancel_order(
    ...
    try:
        ...
        if "not found" in error_message.lower():
            ...
            "already cancelled" in error_message.lower()
            or "cannot be cancelled" in error_message.lower()
        ):
            error_code = "CANNOT_CANCEL"
